...
async function hotoffSearch() {
  ...
  fetch(`/hotoffsearch?search=${search}`, {
    ...
    .then((res) => {
      ...
      let searchCard = document.getElementById("searchCard");
      searchCard.innerHTML=""
      const off_static = document.getElementById("off_static");
      off_static.innerHTML=""
      
      for (let i = 0; i < res.length; i++) {
        s += `<div class="ag-courses_item box_shadow_2">
          <a href="/showprofile?id=${res[i][0]?.reg_id}" class="ag-courses-item_link" id="card${i}">
            <div class="ag-courses-item_bg"></div>
            ...
            <div>
              <div class="row pti_rel_2">
                <div class="col">
                  <div class="jst_ctr">
                      ...
                      <div class="img1"><img class="img" src="/${res[i][0].profile_pic}"></div>
              ...
              <div>
                <div class="crd_emp_name">
                  <p>   ${res[i][0].firstname} </p>
                </div>
              </div>

              <div class="pti_rel_2">
                <div class="crd_designation">
                  <p> ${res[i][0].designation}</p>
                </div>
              </div>
              ...
              <div class="display_flex crd_mail_aln">
                ...
                <div class="clr_drk_grey">${res[i][0].phone_number}</div>
              </div>
            </div>
